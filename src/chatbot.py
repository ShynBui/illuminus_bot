from pkgs.prompt import david_choi_prompt, david_choi_prompt_with_retrieve
...
def get_conversation_with_retrieve(long_term_memory, my_config=None):

    model_input = copy.deepcopy(david_choi_prompt_with_retrieve['model_input'])
    ...
    user_input = copy.deepcopy(david_choi_prompt_with_retrieve['user_input'])
    user_input += 'Input:\n'
    user_input += f'''
{{
  "previous_context": "{my_config["previous_context"]}",
